...
public class SecurityStrategyTest {
	...
	private final BasicAuthStrategy basicAuthApplier = new BasicAuthStrategy();

	private final JWTStrategy jwtApplier = new JWTStrategy();

	private final OAuth2Strategy oAuth2Applier = new OAuth2Strategy();
